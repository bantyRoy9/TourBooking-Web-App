...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center:[84.762127,26.731219],
    // zoom: 10 ,
    // interactive:false
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateAcc.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateAccountSetting = void 0;
...
var updateAccountSetting = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (updateData.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type, " successful!"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
  ...
  return function updateAccountSetting(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateAccountSetting = updateAccountSetting;
...
var stripe = Stripe('pk_test_51Kr47dSJQSj6VWcw1NEJVsLNidjyIUinZyYKp7NwHPq42ZSwXhlOENJRFKgPeECCRyrXqWKvl3LGMZE1l3rJ4TZe00r5TOHauc');
...
var _updateAcc = require("./updateAcc");
...
var bookingbtn = document.getElementById('booking-tour');
...
if (updatebtn) {
  updatebtn.addEventListener('submit', function (e) {
    ...
    (0, _updateAcc.updateAccountSetting)(form, 'data');
  });
}

if (updatePassbtn) {
  updatePassbtn.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateAcc.updateAccountSetting)({
