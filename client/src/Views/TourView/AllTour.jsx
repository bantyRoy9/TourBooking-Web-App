...
import { Alert, FilterForm as Form, TourCard } from "../../Components";
...
const AllTour = () => {
  ...
  const { loading, error, tours, resultPerpage, length } = useSelector(
    (state) => state.tours
  );
            ...
            <div className={`categoriesItem ${catActive}`}>
              ...
              {categories.map((category, idx) => (
                <>
                  ...
                  />
                  <label key={`label${idx}`} htmlFor={category}>
                    {" "}
                    {category}
                  </label>
                  <br />
